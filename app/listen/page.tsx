...
// ===== Featured releases you sent (albums/singles) =====
  ...
  return (
    <main className={styles.wrap}>
      <header className={styles.header}>
        ...
        <p className={styles.tag}>Choose a platform or jump into featured releases.</p>
      </header>
      ...
      <section className={styles.grid}>
        ...
        {/* Add more when ready */}
        {/* <Badge href={ARTISTS.youtube} label="YouTube" logo={<YouTube />} subtle /> */}
      </section>
...
/* helpers */
function logoFor(p: Release["platform"]): ReactNode {
  switch (p) {
